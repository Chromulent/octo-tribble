...
varArray=( 	"How_to_Get_Away_with_Murder_S"
	"Marvels_Jessica_Jones_Season_"
	"Marvels_Luke_Cage_Season_"
	"Marvels_The_Defenders_season_"
	"Marvels_The_Punisher_Season_"
	"My_Name_Is_Earl_Season_"
	"Roman_Empire_Season_"
	"Stranger_Things_Season_"
	"The_Crown_season_"
	"The_Good_Place_Season_"
	"The_Haunting_of_Bly_Manor_"
	"The_Haunting_of_Hill_House_Season_"
	"The_Tick_Season_"
	"Westworld_season_"
)
